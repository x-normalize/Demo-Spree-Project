...
public class Constants {
    ...
    public static final String EDIT_PROFILE_BUTTON = "accountPage.editProfileButton";
    public static final String USERNAME_FIELD_PATH = "registrationPage.emailField";
    public static final String PASSWORD_FIELD_PATH = "registrationPage.passwordField";
    ...
    public static int MAX_LENGTH_USERNAME = 8;
